...
<tr>
    <td>
               ...
               <div class="user-with-avatar {{($f->is_online == 1)?'with-status status-green':''}}">
                   <a href="user/profile/view?user={{$f->friendid}}">
               ...
               <td class="text-right">
                <div class="btn-group mr-1 mb-1">
                    ...
                    <div aria-labelledby="dropdownMenuButton1" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 30px, 0px); top: 0px; left: 0px; will-change: transform;">
                        <a class="dropdown-item" href="#" onclick="acceptfriend('{{ $f->friendid }}');">Accept</a>
                        <a class="dropdown-item" href="#"  onclick="appendtodel('{{ $f->friendid }}');">Decline</a>
                    </div>
                </div>
               </td>                           
             </tr> 
