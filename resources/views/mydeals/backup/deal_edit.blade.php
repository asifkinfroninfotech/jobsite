        ...
        <div class="content-box">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="rianta-img">
                                        @if( (isset($data['deal_info']->profileimage) && !empty($data['deal_info']->profileimage) ) && File::exists(public_path('storage/deal/profileimage/'.$data['deal_info']->profileimage)))
                                          <img src="{{ asset('imagecache/company_logo/'.$data['deal_info']->profileimage) }}" class="img-responsive">
                                          @else
                                          <img src="{{ Avatar::create($data['deal_info']->projectname)->toBase64() }}" style="width:183px;height:61px;" class="img-responsive">
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="element-wrapper">
                        ...
                        <div class="element-box">
                            ...
                            <form action="{{ route('deal.cover.logo.image.store') }}" method="POST" enctype="multipart/form-data" class="dropzone" id="profile_image">
                                {{ csrf_field() }}
                        ...
                        <div class="element-box">
                            ...
                            <form action="{{ route('deal.cover.logo.image.store') }}" method="POST" enctype="multipart/form-data" class="dropzone" id="cover_image">
                                {{ csrf_field() }}
                        ...
                        <div class="element-box">
                            ...
                            <form action="{{ route('deal.video.store') }}" method="POST" enctype="multipart/form-data" class="dropzone" id="my-video">
                                {{ csrf_field() }}
                                <input type="hidden" name="dealid" value="{{$data['deal_info']->dealid}}" />
                                <div class="dz-message">
                                    <div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-8">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" placeholder="Enter Name"
                                                               data-error="Project Name is invalid" required="required" type="text" name="project_name" value="{{old('', $data['deal_info']->projectname)}}">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="currency" onchange="currencychange(this.value);">
                                                            ...
                                                            <option value="{{$currency->currencyid}}" <?php if($currency->currencyid==$data['deal_info']->currencyid){echo "selected";}?>>{{$currency->currencyname}}</option>
                                                ...
                                                <div class="col-sm-12">
                                                 <div class="form-group">
                                                    <label>
                                                      ...
                                                      <textarea class="form-control" name="proposed_uses_of_funds" rows="3">{{ old('',$data['deal_info']->proposedusesoffunds) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                @if(isset($data['investmentstages']))
                                                                  @foreach($data['investmentstages'] as $istage)
                                                                   <option value="{{ $istage->stagename }}"
                                                                    ...
                                                                    {{
                                                                       ($data['deal_info']->investmentstage == $istage->stagename) ? "selected =='selected' " : ''
                                                                    }}
                                                                    @endisset
                    ...
                    <input class="form-control" data-error="Please enter monthly operating costs." placeholder="Monthly Operating Costs" step=".01"
                                                               required="required" data-minlength="1" type="number" name="monthly_operating_costs" value="{{ old('',$data['deal_info']->monthlyoperatingcost) }}">
                  </div>
                    ...
                    <div class="input-group-prepend">
                      <div class="input-group-text currency-symb">
                        {{$data['deal_info']->symbol}}
                                                        ...
                                                        <input class="form-control" data-error="Total investment required is invalid" step=".01"
                                                               placeholder="Total Investment Required" required="required" type="number" name="total_investment_required" value="{{ old('',$data['deal_info']->totalinvestmentrequired) }}">
                                                        </div>
                                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                    ...
                    <div class="input-group-prepend">
                      <div class="input-group-text currency-symb">
                        {{$data['deal_info']->symbol}}
                                                        ...
                                                        <input class="form-control" data-error="Pre money valuation is invalid" step=".01"
                                                        placeholder="Pre Money Valuation" required="required" type="number" name="pre_money_valuation" value="{{ old('',$data['deal_info']->premoneyvaluation) }}">
                                                            </div>
                                                 <div class="help-block form-text with-errors form-control-feedback"></div>
                    ...
                    <div class="input-group-prepend">
                      <div class="input-group-text currency-symb">
                        {{$data['deal_info']->symbol}}
                                                        ...
                                                        <input class="form-control" data-error="Your email address is invalid" step=".01"
                                                               placeholder="Projected IRR(%)"  type="number" name="projected_irr" value="{{ old('',$data['deal_info']->projectedirr) }}">
                                                        </div>
                                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                                                                ...
                                                                @if(isset($data['purposeofrequestedinvestment']))
                                                                  @foreach($data['purposeofrequestedinvestment'] as $pori)
                                                                   <option value="{{ $pori->fund }}"
                                                                    ...
                                                                    {{
                                                                       ($data['deal_info']->purposeofinvestment == $pori->fund) ? "selected =='selected' " : ''
                                                                    }}
                                                                    @endisset
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                                ...
                                                                @if(isset($data['investmentstructures']))
                                                                  @foreach($data['investmentstructures'] as $istruct)
                                                                   <option value="{{ $istruct->name }}"
                                                                    ...
                                                                    {{
                                                                       ($data['deal_info']->investmentstructure == $istruct->name) ? "selected =='selected' " : ''
                                                                    }}
                                                                    @endisset
                                                                    >{{ $istruct->name }}</option>
                                                                  @endforeach
                                                    ...
                                                    @break
                                                     ...
                                                     @endforeach
                                                     <option value="{{$sdgmaster->sdgid}}" <?php echo $selected1;?>>{{$sdgmaster->sdg}}</option>
                                                     @endforeach
                                                     </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        placeholder="{{trans('my_deal.loan_term_years_label')}}"  type="number" name="loan_term_year" value="{{ old('',$data['deal_info']->loanterm_year) }}">
                                                 <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" data-error="Invalid data entered."
                                                            placeholder="{{trans('my_deal.loan_term_months_label')}}"  type="number" name="loan_term_month" value="{{ old('',$data['deal_info']->loanterm_month) }}">
                                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                                        </div>
                                                </div>
                                            ...
                                            @for ($i = 2; $i < 6; $i++)
                                               @php
                                                 $pf_row = $pf_collection->where('year_number', $i)->first();
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-error="Invalid data entered."
                                                    placeholder="Years 2"  type="number" name="Year_{{ $i }}" value="{{$pf_row['projected_year']}}">
                                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                    ...
                    <div class="input-group-prepend">
                      <div class="input-group-text currency-symb">
                        {{$data['deal_info']->symbol}}
                                                            ...
                                                            <input class="form-control" data-error="Invalid data entered."
                                                            placeholder="Total Revenues/Turnover"  type="number" name="Year_{{ $i }}_tr" value="{{$pf_row['totalrevenue']}}">
                                                     </div>
                                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="input-group-prepend">
                      <div class="input-group-text currency-symb">
                        {{$data['deal_info']->symbol}}
                                                        ...
                                                        <input class="form-control" data-error="Invalid data entered."
                                                        placeholder="Total Annual Operating Costs"  type="number" name="Year_{{ $i }}_taoc" value="{{$pf_row['totalannualoperatingcost']}}">
                                                </div>
                                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                    ...
                    <div class="input-group-prepend">
                      <div class="input-group-text currency-symb">
                        {{$data['deal_info']->symbol}}
                                                            ...
                                                            <input class="form-control" data-error="Invalid data entered."
                                                            placeholder="EBITDA"  type="number" name="Year_{{ $i }}_ebtda" value="{{$pf_row['ebitda']}}">
                                                    </div>
                                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="input-group-prepend">
                      <div class="input-group-text currency-symb">
                        {{$data['deal_info']->symbol}}
                                                        ...
                                                        <input class="form-control" data-error="Invalid data entered."
                                                        placeholder="Net Cash"  type="number" name="Year_{{ $i }}_netcash" value="{{$pf_row['netcash']}}">
                                                 </div>
                                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                            ...
                            <div class="controls-above-table">
                                <div class="row">
                                    <div class="col-sm-12 col-lg-4">
                                        <button class="btn btn-sm btn-primary" data-target="#exampleModal1" data-toggle="modal" type="button">{{trans('my_deal.public_upload_btn_label')}}</button>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('deal.document.store')}}" method="POST" enctype="multipart/form-data" class="dropzone" id="upload-files-public">
                                                            {{ csrf_field() }}
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-sm btn-danger" data-dismiss="modal" type="button"> Close</button><button class="btn btn-sm btn-danger" type="button">{{trans('my_deal.public_modal_upload_btn_label')}}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div aria-labelledby="exampleModalLabel" class="modal fade" id="public_document_delete_modal" role="dialog" tabindex="-1" style="display: none;" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" data-dismiss="modal" type="button" id="mdel_close">{{trans('my_deal.btn_del_no')}}</button>
                                                        <button class="btn btn-primary" type="button" onclick="fnDeleteSelectedDocuments('public');" id="btn_del_yes">{{trans('my_deal.btn_del_yes')}}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-lg-8 filter-moble">
                                        <form class="form-inline justify-content-sm-end">
                                            ...
                                            <input ng-model='public_search.documentname' class="form-control form-control-sm rounded bright" placeholder="{{trans('my_deal.input_search_placeholder')}}" type="text">
                                ...
                                <input ng-model="dealid" type="hidden" value="{{$data['deal_info']->dealid}}">
                                     ...
                                     <th class="name">
                                        ...
                                        <tr ng-hide="!publicdoc.length" ng-repeat="public in publicdoc | filter:public_search | filter:filterByExt | orderBy: sortByPublic">              
                                            @verbatim
                                            <td><input class="form-control" type="checkbox" value="{{ public.documentid }}">{{ public.documentname }}</td>
                                            <td>{{ ::public.type }}</td>
                                        ...
                                        <div aria-labelledby="exampleModalLabel" class="modal fade" id="exampleModal2" role="dialog" tabindex="-1" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('deal.document.store')}}" method="POST" enctype="multipart/form-data" class="dropzone" id="upload-files-private">
                                                            {{ csrf_field() }}
                                        ...
                                        <div aria-labelledby="exampleModalLabel" class="modal fade" id="private_document_delete_modal" role="dialog" tabindex="-1" style="display: none;" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" data-dismiss="modal" type="button" id="mdel_close_private">{{trans('my_deal.btn_del_no')}}</button>
                                                        <button class="btn btn-primary" type="button" onclick="fnDeleteSelectedDocuments('private');" id="btn_del_yes_private">{{trans('my_deal.btn_del_yes')}}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <thead>
                                     ...
                                     <tbody id="private_document_table">
                                        <tr ng-hide="!privatedoc.length" ng-repeat="private in privatedoc | filter:private_search | filter:privateFilterByExt | orderBy: sortByPrivate">
                                            <td><input class="form-control" type="checkbox" value="@{{ private.documentid }}">@{{ private.documentname }}</td>
                                            <td>@{{ private.type }}</td>
