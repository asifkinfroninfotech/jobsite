    ...
    <div class="content-i">
            ...
            <div class="element-wrapper" id='helpform'>
                <div class="element-box">
                    <h5 class="form-header">
                        {!!trans('service_provider_profile_edit.help_title')!!}
                    </h5>
                    <div class="form-desc">
                        {!!$helper->GetHelpModifiedText(trans('service_provider_profile_edit.help_content'))!!}
                    </div>
                    <div class="element-box-content example-content">
                        <button class="mr-2 mb-2 btn btn-link" type="button" onclick='hidehelp();'>
                            {{trans('service_provider_profile_edit.help_btn_hide_caption')}}</button>
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-4">
                        ...
                        <div class="up-head-w" style="background-image:url({{ $cover_image }})">
                            ...
                            <div class="up-main-info">
                                ...
                                <h6 class="up-sub-header">
                                    {{trans('service_provider_profile_edit.role_title')}}
                                </h6>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="value-pair">
                                        <div class="label">
                                            {{trans('service_provider_profile_edit.country_title')}}:
                                        </div>
                                        <div class="value">
                    ...
                    <div class="element-wrapper">
                        ...
                        <div class="element-box">
                            <h5 class="form-header">
                                {{trans('service_provider_profile_edit.logo_title')}}
                            </h5>
                            <div class="form-desc">
                                {{trans('service_provider_profile_edit.logo_content')}}
                            </div>
                            <form action="{{ route('company.cover.logo.image.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="dz-message">
                                    <div>
                                        <h4> {{trans('service_provider_profile_edit.logo_drag_and_drop_content')}}</h4>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="element-box">
                            <h5 class="form-header">
                                {{trans('service_provider_profile_edit.cover_title')}}
                            </h5>
                            <div class="form-desc">
                                {{trans('service_provider_profile_edit.cover_content')}}
                            </div>
                            <form action="{{ route('company.cover.logo.image.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="dz-message">
                                    <div>
                                        <h4>{{trans('service_provider_profile_edit.cover_drag_and_drop_content')}}</h4>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="video-rit">
                            <div class="element-wrapper">
                                <h6 class="element-header">
                                    <h4>{{trans('service_provider_profile_edit.video_title')}}</h4>
                                </h6>
                                <div class="element-box">
                        ...
                        <div class="element-box">
                            <h5 class="form-header">
                                <h4>{{trans('service_provider_profile_edit.video_dropdown_title')}}</h4>
                            </h5>
                            <div class="form-desc">
                                {{trans('service_provider_profile_edit.video_content')}}
                            </div>
                            <form action="{{ route('company.video.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="dz-message">
                                    <div>
                                        <h4>{{trans('service_provider_profile_edit.video_drag_and_drop_content')}}</h4>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="steps-w">
                                    <div class="step-triggers">
                                        <a class="step-trigger active" href="#stepContent1">
                                            {{trans('service_provider_profile_edit.company_title')}}
                                        </a>
                                        ...
                                        <div class="step-content active" id="stepContent1">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.company_name_title')}}*
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.status_message_title')}}
                                                        </label>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.number_of_employees_title')}}
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.tax_id')}}
                                                        </label>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.year_founded_title')}}
                                                        </label>
                                                        <input class="form-control" placeholder="{{trans('service_provider_profile_edit.year_founded_placeholder')}}"
                                                            type="number" pattern="[0-9]" data-error="Entered data is invalid."
                                                            name="year_founded" value="{{old('', $data['company_information']->foundedyear)}}">
                                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.email_title')}}
                                                        </label>
                                                        <input class="form-control" placeholder="{{trans('service_provider_profile_edit.email_placeholder')}}"
                                                            type="email" name="email" value="{{old('', $data['company_information']->email)}}">
                                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.telephone_title')}}
                                                        </label>
                                                        <input class="form-control" placeholder="{{trans('service_provider_profile_edit.telephone_placeholder')}}"
                                                            type="text" name="telephone" value="{{old('', $data['company_information']->telephone)}}">
                                                        {{-- <div class="help-block form-text with-errors form-control-feedback"></div>
                                                        --}}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label for="">
                                                    {{trans('service_provider_profile_edit.website_title')}}
                                                </label>
                                                <input class="form-control" placeholder="{{trans('service_provider_profile_edit.website_placeholder')}}"
                                                    type="text" name="website" value="{{old('',$data['company_information']->website)}}">
                                                {{-- <div class="help-block form-text with-errors form-control-feedback"></div>
                                                --}}
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.skype_title')}}
                                                        </label>
                                                        <input class="form-control" placeholder="{{trans('service_provider_profile_edit.skype_placeholder')}}"
                                                            type="text" name="skype" value="{{ old('', $data['company_information']->skype) }}">
                                                        {{-- <div class="help-block form-text with-errors form-control-feedback"></div>
                                                        --}}
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.twitter_title')}}
                                                        </label>
                                                        <div class="input-group">
                                                            ...
                                                            <input class="form-control" placeholder="{{trans('service_provider_profile_edit.twitter_placeholder')}}"
                                            ...
                                            <div class="form-group">
                                                <label for="">
                                                    {{trans('service_provider_profile_edit.address_title')}}
                                                </label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.city_title')}}
                                                        </label>
                                                        <input class="form-control" placeholder="{{trans('service_provider_profile_edit.city_placehlder')}}"
                                                            type="text" name="city" value="{{old('', $data['company_information']->city)}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.postcode_title')}}*
                                                        </label>
                                                        <input class="form-control" data-error="Postcode is required."
                                                            required="required" placeholder="{{trans('service_provider_profile_edit.postcode_placeholder')}}"
                                                            type="text" name="zip" value="{{old('', $data['company_information']->zip)}}">
                                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" data-error="Country is required."
                                                            required="required" name="country" id="country" placeholder="{{trans('service_provider_profile_edit.country_placeholder')}}">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('service_provider_profile_edit.state_title')}}*
                                                        </label>
                                                        <select name="state" id="state" data-error="State is required."
                                                            required="required" class="form-control" placeholder="{{trans('service_provider_profile_edit.state_title_placeholder')}}">
                                            ...
                                            <div>
                                                <h5 class="form-header">
                                                    {{trans('service_provider_profile_edit.service_title')}}
                                                </h5>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="">
                                                                {{trans('service_provider_profile_edit.core_competencies_title')}}

                                                            </label>

                                                            <select multiple="multiple" class="form-control select2"
                                                                name="corecompetency[]" id="corecompetency">
                                                                @foreach($data['cc']['total_cc'] as $cc)
                                                                <option value="{{ $cc->corecompetencyid }}"
                                                                    @if(isset($data['cc']['selected_cc']))
                                                                    @foreach($data['cc']['selected_cc'] as $selsector)
                                                                    @if($selsector->
                                                                    corecompetency_id==$cc->corecompetencyid)
                                                                    selected="true"
                                                                    @endif
                                                                    @endforeach
                                                                    @endif
                                                                    >{{ $cc->corecompetency }}</option>
                                                                @endforeach
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="">
                                                                {{trans('service_provider_profile_edit.sector_title')}}
                                                ...
                                                <div class="form-group">
                                                    <label>
                                                        {{trans('service_provider_profile_edit.about_us_title')}}
                                                ...
                                                <div class="form-group">
                                                    <label>
                                                        {{trans('service_provider_profile_edit.affiliations_title')}}
                                                ...
                                                <div class="form-group">
                                                    <label>
                                                        {{trans('service_provider_profile_edit.previous_clients_title')}}
                                                    </label>
                                                    <textarea class="form-control" name="previous_clients" rows="3">{{ old('',$data['company_information']->previousclients) }}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        {{trans('service_provider_profile_edit.past_clients_title')}}
                                                    </label>
                                            ...
                                            <div class="form-buttons-w text-right">
                                                <input class="btn btn-primary" type="submit" name="user_info" value="{{trans('service_provider_profile_edit.btn_save_title')}}">
                                            </div>
                                        </div>
        ...
        -------------------->
                        <h5 class="element-header">
                            {{trans('service_provider_profile_edit.document_caption')}}
                        </h5>
                        <div class="element-box table-rit-section">
                            <h5 class="form-header">
                                {{trans('service_provider_profile_edit.documents_public_caption')}}
                            </h5>
                            <div class="form-desc">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">
                                                            {{trans('service_provider_profile_edit.document_modal_upload_public_title')}}
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('company.document.store')}}" method="POST"
                                                            ...
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h4>
                                                                        {{trans('service_provider_profile_edit.popup_document_drag_and_drop_content')}}</h4>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">
                                                            {{trans('service_provider_profile_edit.public_modal_title_delete')}}
                                                        </h5>
                                                        <button aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true"> ×</span></button>
                                                    </div>
                                                        ...
                                                        <form>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <h6>
                                                                            {{trans('service_provider_profile_edit.public_modal_title_delete_text')}}
                                                                        </h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="alert alert-success" role="alert" id="del-message-box"
                                                        style="display:none;">
                                                        {{trans('service_provider_profile_edit.public_modal_success')}}
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" data-dismiss="modal" type="button"
                                                            id="mdel_close">{{trans('service_provider_profile_edit.modal_button_cancel_caption')}}</button>
                                                        <button class="btn btn-primary" type="button" onclick="fnDeleteSelectedDocuments('public');"
                                                            id="btn_del_yes">{{trans('service_provider_profile_edit.modal_button_proceed_caption')}}</button>
                                                    </div>
                                                    {{-- --}}
                                                </div>
                                            </div>
                                        ...
                                        <form class="form-inline justify-content-sm-end">
                                            ...
                                            <select ng-model='sortByPublic' class="form-control form-control-sm rounded bright">
                                                <option selected="selected" value="">
                                                    {{trans('service_provider_profile_edit.documents_public_sort')}}
                                                </option>
                              ...
                              <option value="Cancelled">
                                Date
                                            ...
                                            <select ng-model='filterByExt' class="form-control form-control-sm rounded bright">
                                                <option selected="selected" value="">
                                                    {{trans('service_provider_profile_edit.documents_public_select_filter_type')}}
                                                </option>
                                                <option value="txt">
                                                    txt
                                                </option>
                                ...
                                <form action="" method="POST">
                                    ...
                                    <table class="table table-lightborder" ng-controller="document">
                                        <thead>
                                            <tr>
                                                <th class="name">
                                                    {{trans('service_provider_profile_edit.documents_public_table_name')}}
                                                </th>
                                                <th class="type">
                                                    {{trans('service_provider_profile_edit.documents_public_table_type')}}
                                                </th>
                                                <th class="format">
                                                    {{trans('service_provider_profile_edit.documents_public_table_format')}}
                                                </th>
                                                <th class="date">
                                                    {{trans('service_provider_profile_edit.documents_public_table_date')}}
                                                </th>
                                                <th class="action">
                                                    {{trans('service_provider_profile_edit.documents_public_table_action')}}
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody id="public_document_table">
                                            ...
                                            <tr ng-hide="publicdoc.length > 0">
                                                <td colspan="5">{{trans('service_provider_profile_edit.documents_public_not_found')}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </form>
                        ...
                        <div class="element-box table-rit-section">
                            <h5 class="form-header">
                                {{trans('service_provider_profile_edit.documents_private_caption')}}
                            </h5>
                            <div class="form-desc">
                                This virtual filing cabinet is a space for you to upload any materials (including
                                brochures, summaries) that
                                        ...
                                        <div aria-labelledby="exampleModalLabel" class="modal fade" id="exampleModal2"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">
                                                            {{trans('service_provider_profile_edit.popup_upload_private_document_title')}}
                                                        </h5>
                                                        <button aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true"> ×</span></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="{{ route('company.document.store')}}" method="POST"
                                                            ...
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h4>
                                                                        {{trans('service_provider_profile_edit.popup_document_private_drag_and_drop_content')}}</h4>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                        ...
                                        <div aria-labelledby="exampleModalLabel" class="modal fade" id="private_document_delete_modal"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">
                                                            {{trans('service_provider_profile_edit.private_modal_title_delete')}}
                                                        </h5>
                                                        <button aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true"> ×</span></button>
                                                    </div>
                                                        ...
                                                        <form>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <h6>
                                                                            {{trans('service_provider_profile_edit.private_modal_title_delete_text')}}
                                                                        </h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" data-dismiss="modal" type="button"
                                                            id="mdel_close_private">{{trans('service_provider_profile_edit.modal_button_cancel_caption')}}</button>
                                                        <button class="btn btn-primary" type="button" onclick="fnDeleteSelectedDocuments('private');"
                                                            id="btn_del_yes_private">{{trans('service_provider_profile_edit.modal_button_proceed_caption')}}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <select class="form-control form-control-sm rounded bright">
                              <option selected="selected" value="">
                                {{trans('service_provider_profile_edit.documents_private_sort')}}
                              </option>
                              <option value="Pending">
                                Name
                              </option>
                            ...
                            <div class="table-responsive table-responsive-heading-spce">
                                <table class="table table-lightborder" ng-controller="document">
                                    <thead>
                                        <tr>
                                            <th class="name">
                                                {{trans('service_provider_profile_edit.documents_private_table_name')}}
                                            </th>
                                            <th class="type">
                                                {{trans('service_provider_profile_edit.documents_private_table_type')}}
                                            </th>
                                            <th class="format">
                                                {{trans('service_provider_profile_edit.documents_private_table_format')}}
                                            </th>
                                            <th class="date">
                                                {{trans('service_provider_profile_edit.documents_private_table_date')}}
                                            </th>
                                            <th class="action">
                                                {{trans('service_provider_profile_edit.documents_private_table_action')}}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody id="private_document_table">
                                        ...
                                        <tr ng-hide="privatedoc.length > 0">
                                            <td colspan="5">{{trans('service_provider_profile_edit.documents_private_not_found')}}</td>
                                        </tr>
