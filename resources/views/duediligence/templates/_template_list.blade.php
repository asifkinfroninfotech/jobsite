<!-- <div class="table-scroll-popup" id="divtemplatetable"> -->
<div class="table-scroll-popup" id="divtemplatetable" style="max-height: 100%;">
    <table id="editableTable" class="table table-editable table-striped table-lightfont" style="cursor: pointer;">
        <thead>
            <tr>
                ...
                <th>{{trans('dd_template.description_table_heading')}}</th>
        ...
        <tbody>
            ...
            <tr id='{{$m->templateid}}'>
                <td class="text-center uneditable unhover">
                    <input class="form-control tmplate" type="checkbox" id="chk_{{$m->templateid}}" onclick="gettemplatecheck();"
                        disabled>
                </td>
                ...
                <td tabindex="1" id="template_description_{{$m->templateid}}">
                    {{$m->description}}
                </td>
                ...
                <td tabindex="1" class="text-center uneditable unable-btn unhover">
                    <button class="btn btn-primary" type="button" id="btnSelectTemplate" onclick="selectchk('{{$m->templateid}}')">
                        {{trans('dd_template.template_select_btn_label')}}</button>
    ...
    <button style="float:right;" class="btn btn-primary" type="button" id="btnDeleteTemplate" onclick="updatetemplate();">
        {{trans('dd_template.template_save_btn_label')}}</button>
...
<div id="div_tbl_new" style="display:none;">
    <h6>
    ...
    <table id="tbl_new" class="table table-editable table-striped table-lightfont" style="cursor: pointer;">
        ...
        <tbody>
            <tr id="0">
                ...
                <td tabindex="1" id="new-description" style="left:0px;"></td>
                <td tabindex="1" class="text-center uneditable unhover">
    ...
    <button type="button" onclick="createNewTemplate();" class="btn btn-success">{{trans('dd_template.template_save_btn')}}</button>

    <button type="button" onclick="cancelbtn('template');" class="btn btn-success">{{trans('dd_template.template_cancel_btn')}}</button>
