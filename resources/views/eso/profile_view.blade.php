...
<div class="content-w investor-profile-view" ng-app="myApp">
    ...
    <div class="content-i">
            ...
            <div class="element-wrapper" id='helpform'>
                <div class="element-box">
                    <h5 class="form-header">
                        {!!trans('eso_company_profile_view.help_title')!!}
                    </h5>
                    <div class="form-desc">
                        {!!$helper->GetHelpModifiedText(trans('eso_company_profile_view.help_content'))!!}
                    </div>
                    <div class="element-box-content example-content">
                        <button class="mr-2 mb-2 btn btn-link" type="button" onclick='hidehelp();'>
                            {{trans('eso_company_profile_view.help_btn_hide_caption')}}</button>
                    </div>
                </div>
            </div>
            @endif
                ...
                <div class="user-profile">
                    ...
                    <div class="up-head-w" style="background-image:url({{ $cover_image }})">
                        ...
                        <div class="up-main-info">
                            ...
                            <h5 class="up-sub-header">
                                {{-- Investor --}}
                                {{trans('eso_company_profile_view.entity_type')}}
                            </h5>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="value-pair float-left">
                                    <div class="label">
                                        {{-- Country(S): --}}
                                        {{trans('eso_company_profile_view.general_caption_country')}}:
                                    </div>
                                    <div class="value">
                                        {{ $data['country']->name }}
                                    </div>
                    ...
                    <div class="up-contents">
                        <h5 class="element-header">
                            {{trans('eso_company_profile_view.general_company_caption')}}
                        </h5>
                        <div class="row invst-pfl">
                            @if(isset($data['company_information']->name) &&
                            !empty($data['company_information']->name))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_company_name')}}
                                </div>
                                <h5>{{$data['company_information']->name}}</h5>
                            </div>
                            @endif
                            @if(isset($data['company_information']->telephone) &&
                            !empty($data['company_information']->telephone))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_telephone')}}
                                </div>
                        ...
                        <div class="row invst-pfl">
                            @if(isset($data['company_information']->statusmessage) &&
                            !empty($data['company_information']->statusmessage))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_status_message')}}
                                </div>
                                <h5>{{$data['company_information']->statusmessage}}</h5>
                            </div>
                            @endif
                            @if(isset($data['company_information']->numberofemployees) &&
                            !empty($data['company_information']->numberofemployees))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_number_of_employees')}}
                                </div>
                        ...
                        <div class="row invst-pfl">
                            @if(isset($data['company_information']->taxidnumber) &&
                            !empty($data['company_information']->taxidnumber))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_tax_id_number')}}
                                </div>
                            ...
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_twitter')}}
                                </div>
                        ...
                        <div class="row invst-pfl">
                            ...
                            !empty($data['company_information']->website))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_website')}}
                                </div>
                                <h5>{{$data['company_information']->website}}</h5>
                            </div>
                            @endif
                            @if(isset($data['company_information']->email) &&
                            !empty($data['company_information']->email))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_email')}}
                                </div>
                                <h5>{{$data['company_information']->email}}</h5>
                            </div>
                            @endif
                        </div>
                        @if(isset($data['company_information']->skype) && !empty($data['company_information']->skype))
                        <div class="row invst-pfl">
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_skype')}}
                                </div>
                        ...
                        !empty($data['company_information']->address))
                        <div class="row invst-pfl">
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_address')}}
                                </div>
                                <h5>
                    ...
                    <div class="up-contents investment-pdtop">
                        <h5 class="element-header">
                            {{trans('eso_company_profile_view.general_service_offering_caption')}}
                        </h5>
                        <div class="row invst-pfl">
                            @if(isset($data['team_size']->teamsize) && !empty($data['team_size']->teamsize))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{ trans('eso_company_profile_view.general_team_size') }}
                                </div>
                                <h5>{{$data['team_size']->teamsize }}</h5>
                            </div>
                            @endif
                            @if( isset( $data['sectors'] ) && filled ( $data['sectors'] ))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_sectors')}}
                                </div>
                                <h5>
                                    @if( isset( $data['sectors'] ) && filled ( $data['sectors'] ))
                        ...
                        <div class="row invst-pfl">
                            @if( isset($data['company_information']->noofenterprisesupported) &&
                            !empty($data['company_information']->noofenterprisesupported))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{ trans('eso_company_profile_view.general_supported_enterprise') }}
                                </div>
                                <h5>{{ $data['company_information']->noofenterprisesupported }}</h5>
                            </div>
                            @endif

                            @if( isset($data['company_information']->aboutus) &&
                            !empty($data['company_information']->aboutus))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_about_us')}}
                                </div>
                        ...
                        @if( isset($data['company_information']->affiliations) &&
                        !empty($data['company_information']->affiliations))
                        <div class="row invst-pfl">
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('eso_company_profile_view.general_affiliations')}}
                                </div>
        ...
        -------------------->
                ...
                <div class="element-box">
                    <h5 class="form-header">
                        {{trans('eso_company_profile_view.documents_public_caption')}}
                    </h5>
                    <div class="form-desc">
                            ...
                            <div class="col-sm-12">
                                <form class="form-inline justify-content-sm-end">
                                    <input ng-model='public_search.documentname' class="form-control form-control-sm rounded bright"
                                        placeholder="{{trans('eso_company_profile_view.documents_public_search')}}"
                                        type="text">
                                    <select ng-model='sortByPublic' class="form-control form-control-sm rounded bright">
                                        <option selected="selected" value="">
                                            {{trans('eso_company_profile_view.documents_public_sort')}}
                                        </option>
                                    ...
                                    <select ng-model='filterByExt' class="form-control form-control-sm rounded bright">
                                        <option selected="selected" value="">
                                            {{trans('eso_company_profile_view.documents_public_select_filter_type')}}
                                        </option>
                                        <option value="txt">
                                            txt
                                        </option>
                    ...
                    <div class="table-responsive table-responsive-heading-spce">
                        <table class="table table-lightborder" ng-controller="document">
                            <thead>
                                <tr>
                                    <th class="name">
                                        {{trans('eso_company_profile_view.documents_public_table_name')}}
                                    </th>
                                    <th class="type">
                                        {{trans('eso_company_profile_view.documents_public_table_type')}}
                                    </th>
                                    <th class="format">
                                        {{trans('eso_company_profile_view.documents_public_table_format')}}
                                    </th>
                                    <th class="date">
                                        {{trans('eso_company_profile_view.documents_public_table_date')}}
                                    </th>
                                    <th class="action">
                                        {{trans('eso_company_profile_view.documents_public_table_action')}}
                                    </th>
                                </tr>
                            </thead>
                ...
                <div class="element-box">
                    <h5 class="form-header">
                        {{trans('eso_company_profile_view.documents_private_caption')}}
                    </h5>
                    <div class="form-desc">
                        This virtual filing cabinet is a space for you to upload any materials (including brochures,
                        summaries) that
                            ...
                            <div class="col-sm-12">
                                <form class="form-inline justify-content-sm-end">
                                    ...
                                    <select ng-model='sortByPrivate' class="form-control form-control-sm rounded bright">
                                        <option selected="selected" value="">
                                            {{trans('eso_company_profile_view.documents_private_sort')}}
                                        </option>
                                        <option value="documentname">File Name </option>
                                        <option value="extention">Type</option>
                                        <option value="updated">Date</option>
                                    ...
                                    <select ng-model='privateFilterByExt' class="form-control form-control-sm rounded bright">
                                        <option selected="selected" value="">
                                            {{trans('eso_company_profile_view.documents_private_select_filter_type')}}
                                        </option>
                                        <option value="txt">
                                            txt
                                        </option>
                    ...
                    <div class="table-responsive table-responsive-heading-spce">
                        <table class="table table-lightborder" ng-controller="document">
                            <thead>
                                <tr>
                                    <th class="name">
                                        {{trans('eso_company_profile_view.documents_private_table_name')}}
                                    </th>
                                    <th class="type">
                                        {{trans('eso_company_profile_view.documents_private_table_type')}}
                                    </th>
                                    <th class="format">
                                        {{trans('eso_company_profile_view.documents_private_table_format')}}
                                    </th>
                                    <th class="date">
                                        {{trans('eso_company_profile_view.documents_private_table_date')}}
                                    </th>
                                    <th class="action">
                                        {{trans('eso_company_profile_view.documents_private_table_action')}}
                                    </th>
                                </tr>
                            </thead>
        ...
        <div class="content-panel">
            ...
            <div class="element-wrapper">
                <h6 class="element-header">
                    {{trans('eso_company_profile_view.general_team_member')}}
                </h6>
                <div class="element-box-tp">
                    <div class="input-search-w">
                        <input class="form-control rounded bright" id="myInput" placeholder="{{trans('eso_company_profile_view.general_search_team_member')}}"
                            type="search">
                    </div>
            ...
            <!--------------------
               start - right section image gallery
              -------------------->
            ...
            @if(isset($gallery_videos) && !empty($gallery_videos) && count($gallery_videos) > 0 || ($data['videofile']
            !=
            null ))
            <div class="video-rit">
                <div class="element-wrapper">
        ...
        <!--------------------
                END - right section Image Gallery
                -------------------->


        <!--------------------
              right section Video gallery
              -------------------->
