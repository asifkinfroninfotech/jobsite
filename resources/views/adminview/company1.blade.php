                ...
                <div class="os-tabs-w">
                    <div class="os-tabs-controls tab">
                        <ul class="nav nav-tabs upper">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-toggle="tab" onclick="searchtypes('')"
                                    href="#">
                  ...
                  {{trans('adminview.company_investors_select')}} </a> -->
                                ...
                                <a aria-expanded="false" class="nav-link" data-toggle="tab" onclick="searchtypes('aba5f1')"
                                    href="#">
                                    {{trans('adminview.company_investors_select')}} </a>
                  ...
                  {{trans('adminview.company_enterprise_select')}} </a> -->
                                ...
                                <a aria-expanded="false" class="nav-link" data-toggle="tab" onclick="searchtypes('5eab3b')"
                                    href="#">
                                    {{trans('adminview.company_enterprise_select')}} </a>
                  ...
                  href="#">{{trans('adminview.company_serviceproviders_select')}}</a> -->
                                ...
                                <a aria-expanded="false" class="nav-link" data-toggle="tab" onclick="searchtypes('b5aa1d')"
                                    href="#">{{trans('adminview.company_serviceproviders_select')}}</a>
                  ...
                  {{trans('adminview.company_eso_select')}}</a> -->
                                ...
                                <a aria-expanded="false" class="nav-link" data-toggle="tab" onclick="searchtypes('6c2b42')"
                                    href="#">{{trans('adminview.company_eso_select')}}</a>
                ...
                <div class="element-wrapper">
                    ...
                    <div class="col-sm-12 col-md-12 bg-white">
                        <div id="company_filter" class="wmnax company_filter">
                            ...
                            <label class="searchdflex" style="float:right;"><span>Search:</span><span><input type="search"
                                        class="form-control form-control-sm" id="searchcompany" placeholder="" onkeyup=searchfunc();></span></label>
