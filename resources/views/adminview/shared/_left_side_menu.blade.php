        ...
        <div class="desktop-menu menu-side-w menu-activated-on-click">
          ...
          <div class="menu-and-user">            
              <ul class="main-menu">
                  ...
                  <li class="{{$helper->checkurl('dashboard')}}">
                    <a href="/admin/dashboard">
                        <div class="icon-w">
                            <div class="os-icon os-icon-window-content"></div>
                        </div>
                        <span>{{trans('adminview.dashboard_caption')}}</span>
                    </a>
                </li>
                  <li class="{{$helper->checkurl('company')}}">
                      <a href="/admincompany">
                          <div class="icon-w">
                  ...
                  <li class="{{$helper->checkurl('tenant')}}">
                      <a href="/admintenant">
                          <div class="icon-w">
                              <div class="os-icon os-icon-user-male-circle2"></div>
                          </div>
                      ...
                      <li class="{{$helper->checkurl('requests')}}">
