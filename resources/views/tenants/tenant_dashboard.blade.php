...
$SummaryData=$helper->GetSummaryData_Dashboard($tenant1->tenantid);
...
<div class="content-w">
    ...
    <div class="content-i dashboard-row">
            ...
            <div class="element-wrapper" id='helpform'>
                <div class="element-box">
                    <h5 class="form-header">
                        {!!trans('tenant_dashboard.help_title')!!}
                    </h5>
                    <div class="form-desc">
                    ...
                    <div class="element-box-content example-content">
                        <button class="mr-2 mb-2 btn btn-link" type="button" onclick='hidehelp();'>
                            {{trans('tenant_dashboard.help_btn_hide_caption')}}</button>
                    </div>
                </div>
            </div>
            @endif
                ...
                <div class="col-sm-12">
                    <div class="element-wrapper">
                        <h6 class="element-header">
                            {{trans('tenant_dashboard.tenant_dashboard_heading')}}
                        </h6>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="element-box el-tablo">
                                <div class="label">
                                    {{trans('tenant_dashboard.interest_shownby_investor_graph_caption')}}
                                </div>
                                <div class="value">
                        ...
                        <div class="col-sm-4">
                            <div class="element-box el-tablo">
                                <div class="label">
                                    {{trans('tenant_dashboard.investor_assets_UM_caption')}}
                                </div>
                                <div class="value">
                        ...
                        <div class="col-sm-4">
                            <div class="element-box el-tablo">
                                <div class="label">
                                    {{trans('tenant_dashboard.new_pre_registrations_caption')}}
                                </div>
                                <div class="value">
                        ...
                        <div class="col-sm-4">
                            <div class="element-box el-tablo">
                                <div class="label">
                                    {{trans('tenant_dashboard.views_on_pipeline_caption')}}
                                </div>
                                <div class="value">
                        ...
                        <div class="col-sm-4">
                            <div class="element-box el-tablo">
                                <div class="label">
                                    {{trans('tenant_dashboard.views_on_enterprises_caption')}}
                                </div>
                                <div class="value">
                        ...
                        <div class="col-sm-4">
                            <div class="element-box el-tablo">
                                <div class="label">
                                    {{trans('tenant_dashboard.incomplete_profiles_caption')}}
                                </div>
                                <div class="value">
                        ...
                        <div class="col-sm-4">
                            <div class="element-box el-tablo">
                                <div class="label">
                                    {{trans('tenant_dashboard.new_entity_connections_caption')}}
                                </div>
                                <div class="value">
                    ...
                    <div class="element-wrapper" style="margin-top:15px;">
                        <h6 class="element-header">
                            {{trans('tenant_dashboard.sector_charts_heading_caption')}}
                        </h6>
                        <div class="element-box">
                            <div class="os-tabs-w">
                                <div class="os-tabs-controls">
                                    <ul class="nav nav-tabs smaller">
                                        <li class="nav-item" onclick="draw_enterprise_sector_chart();">
                                            <a class="nav-link active" data-toggle="tab" href="#tab_noof_enterprises">{{trans('tenant_dashboard.noof_enterprises_caption')}}</a>
                                        </li>
                                        <li class="nav-item" onclick="draw_sector_chart('Investor');">
                                            <a class="nav-link" data-toggle="tab" href="#tab_noof_investors">{{trans('tenant_dashboard.noof_investors_caption')}}</a>
                                        </li>
                                        <li class="nav-item" onclick="draw_sector_chart('ServiceProvider');">
                                            <a class="nav-link" data-toggle="tab" href="#tab_noof_serviceproviders">{{trans('tenant_dashboard.noof_service_providers_caption')}}</a>
                                        </li>
                                        <li class="nav-item" onclick="draw_sector_chart('Enterprise_Viewed');">
                                            <a class="nav-link" data-toggle="tab" href="#tab_noof_enterprises_viewed">{{trans('tenant_dashboard.enterprises_viewed_caption')}}</a>
                                        </li>
                                        {{-- <li class="nav-item">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab_noof_serviceproviders">
                                        <div class="el-chart-w">
                                            <div class="element-box">
                                                <div class="el-chart-w">
                                                    <canvas height="160" id="mychart_serviceprovider" width="300"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="content-panel">
            ...
            <div class="element-wrapper">
                <h6 class="element-header">
                    {{trans('tenant_dashboard.text_quick_links')}}
                </h6>
                <div class="element-box-tp">
                    <div class="el-buttons-list full-width">
                        ...
                        <a class="btn btn-white btn-sm" id="inviteaddcompany" onclick="fnOpenInviteCompanyPopup();"
                            data-target=".bd-example-modal-sm" data-toggle="modal"><i class="os-icon os-icon-mail-18"></i><span>{{trans('tenant_dashboard.link_invite_company')}}</span></a>
                        <a class="btn btn-white btn-sm" href="/importcompany?tid={{$tenant1->tenantid}}" target="_blank"><i
                                class="os-icon os-icon-edit-1"></i><span>Import Companies </span></a>
            ...
            <div class="element-wrapper">
                <div class="element-box">
                    <h5 class="form-header">
                        {{trans('tenant_dashboard.doughnut_heading_caption')}}
                    </h5>
                    <div class="form-desc">
                        {!!trans('tenant_dashboard.doughnut_description_text')!!}
                    </div>
                    <div class="el-chart-w">
                        <canvas height="200" id="mydonutChart" width="200"></canvas>
                        <div class="inside-donut-chart-label">
                            <strong id="ttl_dd">0</strong><span>{!!trans('tenant_dashboard.doughnut_total_dd_caption')!!}</span>
                        </div>
                    </div>
                    {{-- <div class="el-legend">
            ...
            <div class="element-wrapper">
                <div class="element-box">
                    <h5 class="form-header">
                        {!!trans('tenant_dashboard.pie_heading_caption')!!}
                    </h5>
                    <div class="form-desc">
                        {!!trans('tenant_dashboard.pie_description_text')!!}
                    </div>
                    <div class="el-chart-w">
            ...
            <input type="hidden" id="tenantid" value="{{$tenant1->tenantid}}" />
        </div>
        <!--
    END - Sidebar
    -->
