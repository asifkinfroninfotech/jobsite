                        ...
                        <div class="step-contents">                          
                            ...
                            <div class="step-content" id="stepContent2">                                   
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="firstname" class="form-control" data-error="{{trans('preregister.pre_register_first_name_error')}}" value="{{ old('firstname') }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="lastname" class="form-control" data-error="{{trans('preregister.pre_register_last_name_error')}}"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="">{{trans('preregister.pre_register_username_label')}}</label>
                                            <input name="username" class="form-control" data-error="{{trans('preregister.pre_register_username_error')}}" value="{{ old('username') }}"
                                                   placeholder="{{trans('preregister.pre_register_username_placeholder')}}" required="required" type="Username">
                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" data-match="#inputPassword" data-match-error="{{trans('preregister.pre_register_confirm_password_error')}}" required="required"  
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" data-error="{{trans('preregister.pre_register_user_telephone_error')}}" placeholder="Telephone"
                                                   required="required" data-minlength="12" type="text" name="telephone" value="{{old('telephone')}}" 
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" data-error="{{trans('preregister.pre_register_user_job_title_error')}}" required="required"  
                                                   placeholder="{{trans('preregister.pre_register_user_job_title_label')}}" type="text" name="userposition"> 
                                        </div>
                                    </div>
                                </div>                                
                            ...
                            <div class="step-content financial-section-tab" id="stepContent3">                                    
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control require" data-error="{{trans('preregister.pre_register_email_error')}}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control require" data-error="{{trans('preregister.pre_register_company_telephone_error')}}" placeholder="{{trans('preregister.general_telephone')}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">  
                                        <div class="form-group">
                                            ...
                                            <input class="form-control require" data-error="{{trans('preregister.general_address_error')}}" placeholder="{{trans('preregister.general_address')}}" type="text" name="address" value="{{old('address')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control require" data-error="{{trans('preregister.general_city_error')}}" placeholder="{{trans('preregister.general_city')}}" type="text" name="city" value="{{old('city')}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="{{trans('preregister.general_postcode')}}" type="text" name="zip" value="{{old('zip')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">  
                                        <div class="form-group">
                                            ...
                                            <input class="form-control require" type="text" name="businesssummary"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">  
                                        <div class="form-group">
                                            ...
                                            <input class="form-control require" type="text" data-error="{{trans('preregister.pre_register_company_one_line_pitch_error')}}"
                                                   name="onelinepitch" value="{{old('onelinepitch')}}" placeholder="{{trans('preregister.pre_register_company_one_line_pitch_label')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control require select2" name="specializedsectors[]" multiple="true" style="width: 100%" data-error="{{trans('preregister.investment_sector_of_specialization_error')}}">
                                ...
                                <div class="form-buttons-w text-right">                                    
                                    ...
                                    <a class="btn btn-primary step-trigger-btn" href="#stepContent4" >{{trans('preregister.pre_register_next_button_label')}}</a>
                                </div>
                            </div>
...
//        ];
        ...
        $('#company_id').each(function(){
           var projects;     
            ...
            var companysearch=$('#company_id').val();
            $.get('/projectscompanydata?company='+companysearch, function(response){
                   projects=response; 
                    alert(projects);
                    console.log(projects);
                    
                    projects=[{name:"Vicky Services",
                     statusmessage:"Excellent Service Provider",
                     companytypeid:"b5aa1d",
                     companyid:"kj12opkhkjikop",
                     img:"blCif.jpg"},
                 {name:"Bememorable-ESO",
                     statusmessage:"BM Status Message",
                     companytypeid:"6c2b42",
                     companyid:"qw12opkhkjikdf",
                     img:"0oauu.jpg"}]
...
//        });
    ...
    function checkforemailandpassword()
    {
        ...
        if (password == password1 && checkemail == 0)
        {
            flag = true;
        }
        ...
        {
            $('.confir').text("Password are not same");
        }
        if ($('#emailcheck').val().length == 0)
        {
            $('.email').text("Email must not be empty");
        }
        if (password == password1)
        {
            $('.confir').text("");
        }
        if ($('#emailcheck').val().length > 0 && checkemail > 0)
        {
        ...
        {
            setTimeout(function() {
                // $('#nextconfir').addClass('disabled'); 
                $('.step-trigger').removeClass('active');
                $('.step-content').removeClass('active');
                $('.login-info-step').addClass('active');
