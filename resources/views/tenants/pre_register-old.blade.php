                        ...
                        <div class="step-contents">                          
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="companytype" required="required" data-error="{{trans('preregister.pre_register_first_name_label')}}">
                            ...
                            <div class="step-content" id="stepContent2">                                   
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="email" class="form-control" data-error="{{trans('preregister.pre_register_email_error')}}" 
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" data-match="#inputPassword" data-match-error="{{trans('preregister.pre_register_confirm_password_error')}}" required="required"  
                                                   placeholder="{{trans('preregister.pre_register_confirm_password_placeholder')}}" type="password" name="confirm_password"> 
                                        </div>
                                    </div>
                                </div>                                
                                <div class="row">
                                ...
                                <div class="form-buttons-w text-right">                                    
                                    ...
                                    <a class="btn btn-primary step-trigger-btn next-btn" href="#stepContent3">{{trans('preregister.pre_register_next_button_label')}}</a>
                                </div>
