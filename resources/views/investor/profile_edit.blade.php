    ...
    <div class="content-i">
        <div class="content-box">
            ...
            <div class="element-wrapper" id='helpform'>
                <div class="element-box">
                    <h5 class="form-header">
                        {!!trans('investor_company_profile_edit.help_title')!!}
                    </h5>
                    <div class="form-desc">
                        {!!$helper->GetHelpModifiedText(trans('investor_company_profile_edit.help_content'))!!}
                    </div>
                    <div class="element-box-content example-content">
                        <button class="mr-2 mb-2 btn btn-link" type="button" onclick='hidehelp();'>
                            {{trans('investor_company_profile_edit.help_btn_hide_caption')}}</button>
                    </div>
                </div>
            </div>
            @endif
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="value-pair">
                                        <div class="label">
                                            {{trans('investor_company_profile_edit.general_country')}}:
                                        </div>
                                        <div class="value">
                                    ...
                                    {{-- @php
                                    if(File::exists(public_path('storage/company/profileimage/'.$data['company_information']->profileimage)))
                                    {
                                    echo 'Yes';
                                    }
                                    else {
          ...
          -------------------->
                        <div class="element-box">
                            <h5 class="form-header">
                                {{trans('investor_company_profile_edit.general_logo_title')}}
                            </h5>
                            <div class="form-desc">
                                {{trans('investor_company_profile_edit.general_logo_description')}}
                            </div>
                            <form action="{{ route('company.cover.logo.image.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="dz-message">
                                    <div>
                                        <h4>{{trans('investor_company_profile_edit.general_drag_and_drop')}}</h4>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="element-box">
                            <h5 class="form-header">
                                {{trans('investor_company_profile_edit.general_cover_image_title')}}
                            </h5>
                            <div class="form-desc">
                                {{trans('investor_company_profile_edit.general_cover_image_description')}}
                            </div>
                            <form action="{{ route('company.cover.logo.image.store') }}" method="POST" enctype="multipart/form-data"
          ...
          -------------------->
              ...
              -------------------->
                        ...
                        <div class="video-rit">
                            <div class="element-wrapper">
                                <h6 class="element-header">
                                    <h4>{{trans('investor_company_profile_edit.general_video')}}</h4>
                                </h6>
                                <div class="element-box">
                ...
                -->
                        <div class="element-box">
                            <h5 class="form-header">
                                <h4>{{trans('investor_company_profile_edit.general_video_upload_caption')}}</h4>
                            </h5>
                            <div class="form-desc">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit
                            </div>
                            <form action="{{ route('company.video.store') }}" method="POST" enctype="multipart/form-data"
                                class="dropzone" id="myVideo">
                                {{ csrf_field() }}
                                <div class="dz-message">
                                    <div>
                                        <h4>{{trans('investor_company_profile_edit.general_drag_and_drop')}}</h4>
                ...
                <div class="col-sm-12 col-md-12 col-lg-8">
                                ...
                                <div class="steps-w">
                                    <div class="step-triggers">
                                        <a class="step-trigger active" href="#stepContent1">
                                            {{trans('investor_company_profile_edit.general_company_caption')}}
                                        </a>
                                        <a class="step-trigger" href="#stepContent2">
                                            {{trans('investor_company_profile_edit.investment_caption')}}
                                        </a>
                                    </div>
                                        ...
                                        <div class="step-content active" id="stepContent1">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.general_company_name')}}*
                                                        </label>
                                                        <input class="form-control" placeholder="Enter Organization/Company Name"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.general_email')}}
                                                        </label>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.general_telephone')}}
                                                        </label>
                                            ...
                                            <div class="form-group">
                                                <label for="">
                                                    {{trans('investor_company_profile_edit.general_website')}}
                                                </label>
                                                <input class="form-control" placeholder="Website URL" data-error="Your Website URL is invalid"
                                                    required="required" type="text" name="website" value="{{old('',$data['company_information']->website)}}">
                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.general_skype')}}
                                                        </label>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.general_twitter')}}
                                                        </label>
                                            ...
                                            <div class="form-group">
                                                <label for="">
                                                    {{trans('investor_company_profile_edit.general_address')}}
                                                </label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.general_city')}}
                                                        </label>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.general_postcode')}}*
                                                        </label>
                                                        <input class="form-control" data-error="Postcode / Zip is required."
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.general_state')}}*
                                                        </label>
                                        ...
                                        <div class="step-content" id="stepContent2">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.investment_years_in_impact_investing')}}
                                                        </label>
                                                        <input class="form-control" placeholder="Years In Impact Investing"
                                                            name="yearsinvolved" data-error="Entered data is invalid."
                                                            type="number" pattern="[0-9]" value="{{old('', $data['company_information']->yearsinvolved)}}">
                                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.investment_number_of_investments_to_date')}}
                                                        </label>
                                                        <input class="form-control" placeholder="No of Investments to Date"
                                                            name="numbertodate" data-error="Entered data is invalid."
                                                            type="number" pattern="[0-9]" value="{{old('', $data['company_information']->numbertodate)}}">
                                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.investment_typical_level_of_involvement')}}
                                                        </label>
                                                        <select class="form-control" name="levelofinvolvement">
                                                            <option value="" disabled selected>Select</option>
                                                            @if(isset($data['levelofinvolvement']))
                                                            @foreach($data['levelofinvolvement'] as
                                                            $levelofinvolvement)
                                                            <option value="{{ $levelofinvolvement->involvementlevel }}"
                                                                @isset($data['company_information']->levelofinvolvement)
                                                                {{
                                                                ($data['company_information']->levelofinvolvement ==
                                                                $levelofinvolvement->involvementlevel) ? "selected
                                                                =='selected' " : ''
                                                                }}
                                                                @endisset
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.investment_number_of_employees')}}
                                                        </label>
                                                        <input class="form-control" name="numberofemployees"
                                                            placeholder="No of Employees" data-error="Entered data is invalid."
                                                            type="number" pattern="[0-9]" value="{{old('', $data['company_information']->numberofemployees)}}">
                                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.investment_invest_on_behalf_of_institution')}}
                                                        </label>
                                                        <select class="form-control" name="isonbehalfofinstitution">
                                                            <option value="" disabled selected>Select</option>
                                                            <option value=1 @isset($data['company_information']->isonbehalfofinstitution)
                                                                {{
                                                                ($data['company_information']->isonbehalfofinstitution
                                                                == 1) ? "selected =='selected' " : ''
                                                                }}
                                                                @endisset >
                                                                Yes
                                                            </option>
                                                            <option value=0 @isset($data['company_information']->isonbehalfofinstitution)
                                                                {{
                                                                ($data['company_information']->isonbehalfofinstitution
                                                                == 0) ? "selected =='selected' " : ''
                                                                }}
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{trans('investor_company_profile_edit.investment_tax_id')}}
                                                        </label>
                                                        <input class="form-control" name="taxidnumber" placeholder="Tax Id Number"
                                                            type="text" value="{{ old('', $data['company_information']->taxidnumber) }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ful-wdth-select">
                                                <label for="">
                                                    {{trans('investor_company_profile_edit.investment_sector_of_specialization')}}
                                                </label>
                                                <select class="form-control select2" name="specializedsectors[]"
                                                    ...
                                                    <option value="{{ $sectors->sectorid }}"
                                                        ...
                                                        @foreach($data['sectors']['selected_sector'] as $selsector)
                                                        @if($selsector->sectorid==$sectors->sectorid)
                                                        selected="true"
                                                        @endif
                                                        @endforeach
                                                        @endif
                                            ...
                                            <div class="form-group">
                                                <label>
                                                    {{trans('investor_company_profile_edit.general_mission')}}
                                                </label>
                                                <textarea class="form-control" name="mission" rows="3">{{ old('',$data['company_information']->mission) }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>
                                                    {{trans('investor_company_profile_edit.investment_intended_investment_outcomes')}}
                                                </label>
                    ...
                    -------------------->
                        ...
                        <div class="element-box table-rit-section">
                            <h5 class="form-header">
                                {{trans('investor_company_profile_edit.documents_public_caption')}}
                            </h5>
                            <div class="form-desc">This virtual filing cabinet is a space for you to upload any
                                materials (including brochures, summaries) that
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">
                                                            {{trans('investor_company_profile_edit.general_modal_title_delete')}}
                                                        </h5>
                                                        <button aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true"> ×</span></button>
                                                    </div>
                                                        ...
                                                        <form>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <h6>
                                                                            {{trans('investor_company_profile_edit.general_modal_delete_confirmation')}}
                                                                        </h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="alert alert-success" role="alert" id="del-message-box"
                                                        style="display:none;">
                                                        {{trans('investor_company_profile_edit.general_modal_document_deleted_message')}}
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" data-dismiss="modal" type="button"
                                                            id="mdel_close">{{trans('investor_company_profile_edit.general_modal_button_cancel_caption')}}</button>
                                                        <button class="btn btn-primary" type="button" onclick="fnDeleteSelectedDocuments('public');"
                                                            id="btn_del_yes">{{trans('investor_company_profile_edit.general_modal_button_proceed_caption')}}</button>
                                                    </div>
                                                    {{-- --}}
                                                </div>
                                            </div>
                                        ...
                                        <form class="form-inline justify-content-sm-end">
                                            ...
                                            <select ng-model='sortByPublic' class="form-control form-control-sm rounded bright">
                                                <option selected="selected" value="">
                                                    {{trans('investor_company_profile_edit.documents_public_sort')}}
                                                </option>
                                ...
                                <option value="Cancelled">
                                  Date
                                            ...
                                            <select ng-model='filterByExt' class="form-control form-control-sm rounded bright">
                                                <option selected="selected" value="">
                                                    {{trans('investor_company_profile_edit.documents_public_select_filter_type')}}
                                                </option>
                                                <option value="txt">
                                                    txt
                                                </option>
                                ...
                                <form action="" method="POST">
                                    ...
                                    <table class="table table-lightborder" ng-controller="document">
                                        <thead>
                                            <tr>
                                                <th class="name">
                                                    {{trans('investor_company_profile_edit.documents_public_table_name')}}
                                                </th>
                                                <th class="type">
                                                    {{trans('investor_company_profile_edit.documents_public_table_type')}}
                                                </th>
                                                <th class="format">
                                                    {{trans('investor_company_profile_edit.documents_public_table_format')}}
                                                </th>
                                                <th class="date">
                                                    {{trans('investor_company_profile_edit.documents_public_table_date')}}
                                                </th>
                                                <th class="action">
                                                    {{trans('investor_company_profile_edit.documents_public_table_action')}}
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody id="public_document_table">
                                            ...
                                            <tr ng-hide="publicdoc.length > 0">
                                                <td colspan="5">{{trans('investor_company_profile_edit.documents_public_not_found')}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </form>
                        ...
                        <div class="element-box table-rit-section">
                            <h5 class="form-header">
                                {{trans('investor_company_profile_edit.documents_private_caption')}}
                            </h5>
                            <div class="form-desc">This virtual filing cabinet is a space for you to upload any
                                materials (including brochures, summaries) that
                                support the communication of your core activity </div>
                            <div class="controls-above-table">
                                        ...
                                        <div aria-labelledby="exampleModalLabel" class="modal fade" id="private_document_delete_modal"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" data-dismiss="modal" type="button"
                                                            id="mdel_close_private">{{trans('investor_company_profile_edit.general_modal_button_cancel_caption')}}</button>
                                                        <button class="btn btn-primary" type="button" onclick="fnDeleteSelectedDocuments('private');"
                                                            id="btn_del_yes_private">{{trans('investor_company_profile_edit.general_modal_button_proceed_caption')}}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                              ...
                              <select class="form-control form-control-sm rounded bright">
                                <option selected="selected" value="">
                                  {{trans('investor_company_profile_edit.documents_private_sort')}}
                                </option>
                                <option value="Pending">
                                  Name
                                </option>
                            ...
                            <div class="table-responsive table-responsive-heading-spce">
                                <table class="table table-lightborder" ng-controller="document">
                                    <thead>
                                        <tr>
                                            <th class="name">
                                                {{trans('investor_company_profile_edit.documents_private_table_name')}}
                                            </th>
                                            <th class="type">
                                                {{trans('investor_company_profile_edit.documents_private_table_type')}}
                                            </th>
                                            <th class="format">
                                                {{trans('investor_company_profile_edit.documents_private_table_format')}}
                                            </th>
                                            <th class="date">
                                                {{trans('investor_company_profile_edit.documents_private_table_date')}}
                                            </th>
                                            <th class="action">
                                                {{trans('investor_company_profile_edit.documents_private_table_action')}}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody id="private_document_table">
                                        ...
                                        <tr ng-hide="privatedoc.length > 0">
                                            <td colspan="5">{{trans('investor_company_profile_edit.documents_private_not_found')}}</td>
                                        </tr>
