              ...
              <div class="user-profile">
                ...
                <div class="up-contents">
                  <h5 class="element-header">
                      {{trans('frontend/investor/user/view.general.company_caption')}}
                  </h5>
                  <div class="row invst-pfl">
                    <div class="col-sm-5">
                     <div class="label">
                       {{trans('frontend/investor/user/view.general.company_name')}}
                     </div>
                      <h5>{{$data['company_information']->name}}</h5>
                    </div>
                    <div class="col-sm-7">
                        <div class="label">
                          {{trans('frontend/investor/user/view.general.telephone')}}
                        </div>
                  ...
                  <div class="row invst-pfl">
                    <div class="col-sm-5">
                      <div class="label"> 
                       {{trans('frontend/investor/user/view.general.website')}}
                     </div>
                      <h5>{{$data['company_information']->website}}</h5>
                    </div>
                    <div class="col-sm-7">
                      <div class="label">
                         {{trans('frontend/investor/user/view.general.email')}}
                      </div>
                  ...
                  <div class="row invst-pfl">
                    <div class="col-sm-5">
                      <div class="label">
                         {{trans('frontend/investor/user/view.general.skype')}}
                      </div>
                      <h5>{{$data['company_information']->skype}}</h5>
                    </div>
                    <div class="col-sm-7">
                      <div class="label">
                        {{trans('frontend/investor/user/view.general.twitter')}}
                      </div>
                  ...
                  <div class="row invst-pfl">
                      <div class="col-sm-12 col-lg-6">
                        <div class="label">
                          {{trans('frontend/investor/user/view.general.address')}}
                        </div>
                ...
                <div class="up-contents investment-pdtop">
                    <h5 class="element-header">
                        {{trans('frontend/investor/user/view.investment.caption')}}
                    </h5>
                    <div class="row invst-pfl">
                      <div class="col-sm-5">
                        <div class="label">
                          {{trans('frontend/investor/user/view.investment.years_in_impact_investing')}}
                        </div>
                        <h5>{{$data['company_information']->yearsinvolved }}</h5>
                      </div>
                      <div class="col-sm-7">
                          <div class="label">
                            {{trans('frontend/investor/user/view.investment.number_of_investments_to_date')}}
                          </div>
                    ...
                    <div class="row invst-pfl">
                      <div class="col-sm-5">
                        <div class="label">
                          {{trans('frontend/investor/user/view.investment.preferred_avg_investment_size')}}
                        </div>
                        <h5>{{$data['company_information']->preferedinvestmentaveragesize}}</h5>
                      </div>
                      <div class="col-sm-7">
                        <div class="label">
                          {{trans('frontend/investor/user/view.investment.funds_under_management')}}
                        </div>
                    ...
                    <div class="row invst-pfl">
                      <div class="col-sm-5">
                        <div class="label">
                          {{trans('frontend/investor/user/view.investment.invest_on_behalf_of_institution')}}
                        </div>
                        <h5>{{$data['company_information']->isonbehalfofinstitution}}</h5>
                      </div>
                      <div class="col-sm-7">
                        <div class="label">
                        {{trans('frontend/investor/user/view.investment.sector_of_specialization')}}
                      </div>
                    ...
                    <div class="row invst-pfl">
                        <div class="col-sm-5">
                          <div class="label">
                            {{trans('frontend/investor/user/view.investment.typical_level_of_involvement')}}
                          </div> 
                          <h5>{{$data['company_information']->levelofinvolvement}}</h5>
                        </div>
                        <div class="col-sm-7">
                          <div class="label">
                          {{trans('frontend/investor/user/view.investment.number_of_employees')}}
                          </div>
                ...
                <div class="up-contents brdtop">
                  ...
                  <div class="mission-row">
                    <h5 class="element-inner-header">
                      {{trans('frontend/investor/user/view.investment.intended_investment_outcomes')}}
                    </h5>
            ...
            <div class="element-wrapper margin-top">
              ...
              <div class="element-box">
                <h5 class="form-header">
                  {{trans('frontend/investor/user/view.documents.public.caption')}}
                </h5>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <form class="form-inline justify-content-sm-end">
                        <input class="form-control form-control-sm rounded bright" id="public_document" onkeyup="publicDocuments()" placeholder="{{trans('frontend/investor/user/view.documents.public.search')}}" type="text">
                        <select class="form-control form-control-sm rounded bright">
                          <option selected="selected" value="">
                            {{trans('frontend/investor/user/view.documents.public.sort')}}
                          </option>
                        ...
                        <select class="form-control form-control-sm rounded bright">
                          <option selected="selected" value="">
                            {{trans('frontend/investor/user/view.documents.public.select_filter_type')}}
                          </option>
                          <option value="Pending">
                            Filter Type 1
                          </option>
                ...
                <div class="table-responsive table-responsive-heading-spce">
                  <table class="table table-lightborder">
                    <thead>
                      <tr>
                        <th class="name">
                          {{trans('frontend/investor/user/view.documents.public.table.name')}}
                        </th>
                        <th class="type">
                          {{trans('frontend/investor/user/view.documents.public.table.type')}}
                        </th>
                        <th class="format">
                          {{trans('frontend/investor/user/view.documents.public.table.format')}}
                        </th>
                        <th class="date">
                          {{trans('frontend/investor/user/view.documents.public.table.date')}}
                        </th>
                        <th class="action">
                          {{trans('frontend/investor/user/view.documents.public.table.action')}}
                        </th>
                      </tr>
                    </thead>
              ...
              <div class="element-box">
                <h5 class="form-header">
                   {{trans('frontend/investor/user/view.documents.private.caption')}}
                </h5>
                <div class="form-desc">This virtual filing cabinet is a space for you to upload any materials (including brochures, summaries) that
                  support the communication of your core activity </div>
                <div class="controls-above-table">
                  <div class="row">
                    <div class="col-sm-12">
                      <form class="form-inline justify-content-sm-end">
                        ...
                        id="document" onkeyup="documents()" placeholder="{{trans('frontend/investor/user/view.documents.private.search')}}" type="text">
                        <select class="form-control form-control-sm rounded bright"
                        id="mySelect" onchange="sortTable()">
                          <option selected="selected" value="">
                            {{trans('frontend/investor/user/view.documents.private.sort')}}
                          </option>
                          <option value="Pending">
                            Name
                          </option>
                        ...
                        <select class="form-control form-control-sm rounded bright">
                          <option selected="selected" value="">
                            {{trans('frontend/investor/user/view.documents.private.select_filter_type')}}
                          </option>
                          <option value="Pending">
                            Filter Type 1
                          </option>
                ...
                <div class="table-responsive table-responsive-heading-spce">
                  <table class="table table-lightborder">
                    <thead>
                      <tr>
                        <th class="name">
                          {{trans('frontend/investor/user/view.documents.private.table.name')}}
                        </th>
                        <th class="type">
                          {{trans('frontend/investor/user/view.documents.private.table.type')}}
                        </th>
                        <th class="format">
                          {{trans('frontend/investor/user/view.documents.private.table.format')}}
                        </th>
                        <th class="date">
                          {{trans('frontend/investor/user/view.documents.private.table.date')}}
                        </th>
                        <th class="action">
                          {{trans('frontend/investor/user/view.documents.private.table.action')}}
                        </th>
                      </tr>
                    </thead>
                    <tbody  id="myTable">
          ...
          <div class="content-panel">
            ...
            <div class="element-wrapper">
              <h6 class="element-header">
                {{trans('frontend/investor/user/view.general.team_member')}}
              </h6>
              <div class="element-box-tp">
                <div class="input-search-w">
                  <input class="form-control rounded bright" id="myInput" onkeyup="memberSearch()"  placeholder="{{trans('frontend/investor/user/view.general.search_team_member')}}" type="search">
                </div>
            ...
            <div class="video-rit">
              <div class="element-wrapper">
                <h6 class="element-header">
                   {{trans('frontend/investor/user/view.general.video')}}
                </h6>
                <div class="element-box">
