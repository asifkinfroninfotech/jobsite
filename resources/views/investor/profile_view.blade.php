...
<div class="content-w investor-profile-view" ng-app="myApp">
    ...
    <div class="content-i">
        <div class="content-box">
            ...
            <div class="element-wrapper" id='helpform'>
                <div class="element-box">
                    <h5 class="form-header">
                        {!!trans('investor_company_profile_view.help_title')!!}
                    </h5>
                    <div class="form-desc">
                        {!!$helper->GetHelpModifiedText(trans('investor_company_profile_view.help_content'))!!}
                    </div>
                    <div class="element-box-content example-content">
                        <button class="mr-2 mb-2 btn btn-link" type="button" onclick='hidehelp();'>
                            {{trans('investor_company_profile_view.help_btn_hide_caption')}}</button>
                    </div>
                </div>
            </div>
            @endif
                ...
                <div class="user-profile">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="value-pair float-left">
                                    <div class="label">
                                        {{-- Country(S): --}}
                                        {{trans('investor_company_profile_view.general_country')}}:
                                    </div>
                                    <div class="value">
                                        {{ $data['country']->name }}
                                    </div>
                    ...
                    <div class="up-contents">
                        <h5 class="element-header">
                            {{trans('investor_company_profile_view.general_company_caption')}}
                        </h5>
                        <div class="row invst-pfl">
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('investor_company_profile_view.general_company_name')}}
                                </div>
                                <h5>{{$data['company_information']->name}}</h5>
                            </div>
                            @if(isset($data['company_information']->telephone))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('investor_company_profile_view.general_telephone')}}
                                </div>
                        ...
                        <div class="row invst-pfl">
                            @if(isset($data['company_information']->website))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('investor_company_profile_view.general_website')}}
                                </div>
                                <h5>{{$data['company_information']->website}}</h5>
                            </div>
                            @endif
                            @if(isset($data['company_information']->email))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('investor_company_profile_view.general_email')}}
                                </div>
                        ...
                        <div class="row invst-pfl">
                            ...
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('investor_company_profile_view.general_skype')}}
                                </div>
                            ...
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('investor_company_profile_view.general_twitter')}}
                                </div>
                        ...
                        <div class="row invst-pfl">
                            <div class="col-sm-12 col-lg-6">
                                <div class="label">
                                    {{trans('investor_company_profile_view.general_address')}}
                                </div>
                    ...
                    <div class="up-contents investment-pdtop">
                        <h5 class="element-header">
                            {{trans('investor_company_profile_view.investment_caption')}}
                        </h5>
                        <div class="row invst-pfl">
                            @if(isset($data['company_information']->yearsinvolved))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('investor_company_profile_view.investment_years_in_impact_investing')}}
                                </div>
                                <h5>{{$data['company_information']->yearsinvolved }}</h5>
                            </div>
                            @endif
                            @if(isset($data['company_information']->numbertodate))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('investor_company_profile_view.investment_number_of_investments_to_date')}}
                                </div>
                        ...
                        <div class="row invst-pfl">
                            @if(isset($data['company_information']->preferedinvestmentaveragesize))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('investor_company_profile_view.investment_preferred_avg_investment_size')}}
                                </div>
                                <h5>{{$data['currencysymbol']->symbol.$data['company_information']->preferedinvestmentaveragesize}}</h5>
                            </div>
                            @endif
                            @if(isset($data['company_information']->fundsundermanagement))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('investor_company_profile_view.investment_funds_under_management')}}
                                </div>
                                <h5>{{$data['currencysymbol']->symbol.$data['company_information']->fundsundermanagement}}</h5>
                            </div>
                            @endif
                        </div>
                        <div class="row invst-pfl">
                            @if(isset($data['company_information']->isonbehalfofinstitution))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('investor_company_profile_view.investment_invest_on_behalf_of_institution')}}
                                </div>
                            ...
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('investor_company_profile_view.investment_sector_of_specialization')}}
                                </div>
                                @if( isset( $data['sectors'] ) && filled ( $data['sectors'] ))
                        ...
                        <div class="row invst-pfl">
                            @if(isset($data['company_information']->levelofinvolvement))
                            <div class="col-sm-5">
                                <div class="label">
                                    {{trans('investor_company_profile_view.investment_typical_level_of_involvement')}}
                                </div>
                                <h5>{{$data['company_information']->levelofinvolvement}}</h5>
                            </div>
                            @endif
                            @if(isset($data['company_information']->numberofemployees))
                            <div class="col-sm-7">
                                <div class="label">
                                    {{trans('investor_company_profile_view.investment_number_of_employees')}}
                                </div>
                    ...
                    <div class="up-contents brdtop">
                        @if(isset($data['company_information']->mission) && !empty(
                        $data['company_information']->mission) )
                        ...
                        @endif
                        @if(isset($data['company_information']->outcomes) && !empty(
                        $data['company_information']->outcomes) )
                        <div class="mission-row">
                            <h5 class="element-inner-header">
                                {{trans('investor_company_profile_view.investment_intended_investment_outcomes')}}
                            </h5>
            ...
            <div class="element-wrapper margin-top">
              ...
              -------------------->
                ...
                <div class="element-box">
                    <h5 class="form-header">
                        {{trans('investor_company_profile_view.documents_public_caption')}}
                    </h5>
                    <div class="form-desc">This virtual filing cabinet is a space for you to upload any materials
                        (including brochures, summaries) that
                            ...
                            <div class="col-sm-12">
                                <form class="form-inline justify-content-sm-end">
                                    ...
                                    <input ng-model='public_search.documentname' class="form-control form-control-sm rounded bright"
                                        placeholder="{{trans('investor_company_profile_view.documents_public_search')}}"
                                        type="text">
                                    <select ng-model='sortByPublic' class="form-control form-control-sm rounded bright">
                                        <option selected="selected" value="">
                                            {{trans('investor_company_profile_view.documents_public_sort')}}
                                        </option>
                                    ...
                                    <select ng-model='filterByExt' class="form-control form-control-sm rounded bright">
                                        <option selected="selected" value="">
                                            {{trans('investor_company_profile_view.documents_public_select_filter_type')}}
                                        </option>
                                        <option value="txt">
                                            txt
                                        </option>
                    ...
                    <div class="table-responsive table-responsive-heading-spce">
                        <table class="table table-lightborder" ng-controller="document">
                            <thead>
                                <tr>
                                    <th class="name">
                                        {{trans('investor_company_profile_view.documents_public_table_name')}}
                                    </th>
                                    <th class="type">
                                        {{trans('investor_company_profile_view.documents_public_table_type')}}
                                    </th>
                                    <th class="format">
                                        {{trans('investor_company_profile_view.documents_public_table_format')}}
                                    </th>
                                    <th class="date">
                                        {{trans('investor_company_profile_view.documents_public_table_date')}}
                                    </th>
                                    <th class="action">
                                        {{trans('investor_company_profile_view.documents_public_table_action')}}
                                    </th>
                                </tr>
                            </thead>
                            <tbody id="public_document_table">
                                ...
                                <tr ng-hide="publicdoc.length > 0">
                                    <td colspan="5">{{trans('investor_company_profile_view.documents_public_not_found')}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="element-box">
                    <h5 class="form-header">
                        {{trans('investor_company_profile_view.documents_private_caption')}}
                    </h5>
                    <div class="form-desc">This virtual filing cabinet is a space for you to upload any materials
                        (including brochures, summaries) that
                        support the communication of your core activity </div>
                            ...
                            <div class="col-sm-12">
                                <form class="form-inline justify-content-sm-end">
                                    ...
                                    <select ng-model='sortByPrivate' class="form-control form-control-sm rounded bright">
                                        <option selected="selected" value="">
                                            {{trans('investor_company_profile_view.documents_private_sort')}}
                                        </option>
                                        <option value="documentname">File Name </option>
                                        <option value="extention">Type</option>
                                        <option value="updated">Date</option>
                    ...
                    <div class="table-responsive table-responsive-heading-spce">
                        <table class="table table-lightborder" ng-controller="document">
                            <thead>
                                <tr>
                                    <th class="name">
                                        {{trans('investor_company_profile_view.documents_private_table_name')}}
                                    </th>
                                    <th class="type">
                                        {{trans('investor_company_profile_view.documents_private_table_type')}}
                                    </th>
                                    <th class="format">
                                        {{trans('investor_company_profile_view.documents_private_table_format')}}
                                    </th>
                                    <th class="date">
                                        {{trans('investor_company_profile_view.documents_private_table_date')}}
                                    </th>
                                    <th class="action">
                                        {{trans('investor_company_profile_view.documents_private_table_action')}}
                                    </th>
                                </tr>
                            </thead>
                            <tbody id="private_document_table">
                                ...
                                <tr ng-hide="privatedoc.length > 0">
                                    <td colspan="5">{{trans('investor_company_profile_view.documents_private_not_found')}}</td>
                                </tr>
        ...
        <div class="content-panel">
            ...
            <div class="element-wrapper">
                <h6 class="element-header">
                    {{trans('investor_company_profile_view.general_team_member')}}
                </h6>
                <div class="element-box-tp">
                    <div class="input-search-w">
                        <input class="form-control rounded bright" id="myInput" placeholder="{{trans('investor_company_profile_view.general_search_team_member')}}"
                            type="search">
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <a rel="g-1" class="element-box el-tablo centered trend-in-corner padded swipebox"
                                        href="/storage/company/gallery/images/{{$gallery_images[$gallery_last_count]->galleryname}}"
                                        title="{{$gallery_images[$gallery_last_count]->galleryname}}">
                                        <img src="/imagecache/company_image_gallery/{{$gallery_images[$gallery_last_count]->gallerytitle}}"
                                            alt="image">
                                    </a>
                                </div>
                            </div>
